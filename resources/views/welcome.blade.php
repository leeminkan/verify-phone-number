...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-6">
                    ...
                    <div class="col-12">
                        <button id="vefiryCode">Verify Code</button>
                    </div>
                </div>
            </div>
            <div class="row">
            ...
            <div class="row">
                <div class="col-6">
                    ...
                    <div class="col-12">
                        <button id="vefiryIdToken">Verify IdToken</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <script defer src="https://www.gstatic.com/firebasejs/7.16.0/firebase-firestore.js"></script>
